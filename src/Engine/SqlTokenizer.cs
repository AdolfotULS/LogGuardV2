...
namespace LogGuardV2.src.Engine
{
    ...
    public static class SqlTokenizer
    {
            ...
            new(160, StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["PG_TABLES"]          = "SYSTEM_TABLE",
            ["PG_CLASS"]           = "SYSTEM_TABLE",
            ["PG_ATTRIBUTE"]       = "SYSTEM_TABLE",
            ["PG_NAMESPACE"]       = "SYSTEM_TABLE",
            ["PG_SETTINGS"]        = "SYSTEM_TABLE",
            ["PG_STAT_ACTIVITY"]   = "SYSTEM_TABLE",
            ["PG_LOCKS"]           = "SYSTEM_TABLE",
            ["PG_CATALOG"]         = "SYSTEM_TABLE",
            ["PG_TYPE"]            = "SYSTEM_TABLE",
            ["PG_INDEX"]           = "SYSTEM_TABLE",
            ["PG_CONSTRAINT"]      = "SYSTEM_TABLE",
